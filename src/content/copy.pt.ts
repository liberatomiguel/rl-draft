...
export const PT: Copy = {
  ...
  HOME: {
    ...
    challenges: "Desafios",
    challengesDesc: "Puzzles de draft liberados por rank.",
    challengesLocked: "Bloqueado — desbloqueia no Bronze",
    signInNudge: "Faça login pra salvar seu progresso e subir nas leaderboards",
    leaderboards: "Rankings",
    leaderboardsDesc: "Seus melhores elencos e marcos.",
  ...
  CHALLENGES_UI: {
    title: "Desafios",
    subtitle:
      "Puzzles liberados por rank. Monte um time melhor que uma line histórica fixa sob uma condição e vença a série. Desafios concluídos dão XP e ficam marcados.",
    modeLockedTitle: "Desafios bloqueados",
    modeLockedBody:
      "Chegue ao rank Bronze (200 XP) para liberar os Desafios — o mesmo gate da Coleção. Termine uma run ou duas para chegar lá.",
    progress: (done: number, total: number) => `${done} / ${total} concluídos`,
    tier: { common: "Comum", rare: "Raro", epic: "Épico", legend: "Lendário" } as Record<string, string>,
    status: { locked: "Bloqueado", available: "Disponível", cleared: "Concluído" },
    unlocksAt: (rank: string) => `Libera em ${rank}`,
    clearPrereq: (title: string) => `Conclua “${title}” antes`,
    rewardXp: (xp: number) => `+${xp} XP`,
    briefTargetKicker: "A line que você enfrenta",
    briefTwistKicker: "A condição",
    noTwist: "Sem condição — só monte um time melhor.",
    twist: {
      maxOverall: (n: number) => `Nenhum jogador acima de ${n} OVR`,
      region: (r: string) => `Só elenco ${r}`,
      season: (s: string) => `Drafte só de ${s}`,
      country: (c: string) => `Só jogadores de ${c}`,
      noSpecials: "Sem cartas especiais",
      fixed: (name: string) => `Monte em volta de ${name}`,
    },
    start: "Iniciar desafio",
    vs: "vs",
    yourTeam: "Seu time",
    theBoss: "A line",
    toMatch: "Encarar a line",
    bestOf: (n: number) => `Melhor de ${n}`,
    playSeries: "Jogar a série",
    simulating: "Simulando…",
    skip: "Pular",
    clearedTitle: "Desafio concluído!",
    clearedSub: "Puzzle resolvido — recompensa garantida.",
    failedTitle: "Não foi dessa vez",
    failedSub: "A line resistiu. Refaça o draft e tente de novo.",
  ...
  LEADERBOARDS_UI: {
    ...
    save: "Salvar",
    saved: "Salvo",
    nameTaken: "Esse nome já está em uso — tente outro.",
    signedInEmail: (email: string) => `Logado como ${email}`,
    deleteAccount: "Excluir conta",
    deleteTitle: "Excluir sua conta?",
    deleteBody:
      "Isso remove permanentemente sua conta e todos os dados na nuvem — progresso sincronizado, entradas no ranking e nome de exibição. Seu progresso local neste dispositivo é mantido. Não dá pra desfazer.",
    deleteConfirm: "Excluir para sempre",
    cancel: "Cancelar",
    account: "Conta",
    signOut: "Sair",
    signedInAs: (name: string) => `Logado como ${name}`,
    syncing: "Sincronizando…",
    guestNote:
      "Jogando como convidado — seu progresso fica salvo neste dispositivo. Entre com seu email para fazer backup na nuvem e competir globalmente. Seu progresso local é mesclado, nunca perdido.",
    comingSoon: "Os rankings globais abrem quando as contas entrarem no ar. Até lá, seus recordes ficam salvos localmente.",
    globalTab: "Global",
    youTab: "Seus recordes",
    rankCol: "#",
    you: "Você",
    empty: "Ainda sem entradas — seja o primeiro.",
    none: "—",
    categories: {
      best_normal: "Maior overall · Normal",
      best_easy: "Maior overall · Easy",
      best_hard: "Maior overall · Hard",
      best_legacy: "Maior overall · Legacy",
      best_worldwide: "Maior overall · Mundial",
      best_sam: "Maior overall · Regional",
      championships: "Títulos · Total",
      titles_normal: "Títulos · Normal",
      titles_hard: "Títulos · Hard",
      titles_legacy: "Títulos · Legacy",
      titles_easy: "Títulos · Easy",
      xp: "XP total",
      mmr: "MMR · Habilidade",
      daily_streak: "Sequência diária",
      challenges_cleared: "Desafios concluídos",
  ...
  PROFILE_UI: {
    ...
    hidden: "Oculto",
    viewRun: "Ver esta run",
    runDetailTitle: "Resumo da run",
    chemistry: "Química",
    conceded: "Sofridos",
    teamOverallLabel: "Overall do time",
    wonBy: (name: string) => `Campeão: ${name}`,
    olderRun: "De uma run anterior — detalhes limitados.",
