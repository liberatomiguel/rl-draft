...
export const PT: Copy = {
  ...
  LEADERBOARDS_UI: {
    ...
    signInDiscord: "Entrar com Discord",
    signOut: "Sair",
    signedInAs: (name: string) => `Logado como ${name}`,
    syncing: "Sincronizando…",
    guestNote:
      "Jogando como convidado — seu progresso fica salvo neste dispositivo. Entre com o Discord para fazer backup na nuvem e competir globalmente. Seu progresso local é mesclado, nunca perdido.",
